...
(function (root, factory) {
    ...
    SelectionState.prototype.init = function (properties, single) {
        var that = this;
        ...
        this.subscriptions.push(this.selection.subscribe(function (selection) {
            setAll(that.selection(), properties.selected, false);
        }, this, 'beforeChange'));
        ...
        setAll(this.selection(), properties.selected, true);
        ...
        if (this.focused()) {
            set(this.focused(), properties.focused, true);
        }
    };
    ...
    SelectionState.prototype.ensureValidState = function () {
        if (!this.items) {
    ...
    ko.bindingHandlers.selection = {
        init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            selectionState.ensureValidState();
            selectionState.init(properties, single);
